...
## Inhoud
<!-- Dit zorgt wel dat het volledige eerste scherm inhoud is -->
<!-- Is idd wel handig voor langere pagina's -->
<!-- Mss met opmaak, beste van beide (wel voor later, esthetica) -->
...
<!-- Ik zou dit niet in het midden van de paragraaf zetten -->
...
2. Vanuit het mengreservoir transporteren aparte pompen de gemengde vloeistof naar de lades. 
In de kast is er voldoende ruimte voor twee laden met planten varierend in hoogte, om deze reden maken we gebruik van twee pompen voor de toevoer. Aan elke pomp kunnen darmpjes op verschillende hoogtes worden aangesloten, waardoor we een modulair systeem hebben gecreëerd dat eenvoudig uitbreidbaar en aanpasbaar is.
...
Het schema van onze PCB is [hier](https://github.com/Vertical-Farming-IB3/Plan-T/blob/main/Water/PCB/Schematic.pdf) terug te vinden. De pin-out van de in- en outputs is [hier](https://github.com/Vertical-Farming-IB3/Plan-T/blob/main/Water/PCB/PCB.md#pinout) terug te vinden.
...
<!--3 links naar +- dezelfde locatie-->

<!--Voelt hier een beetje als een opleisting-->
...
### Pompaansturing
De watercirculatie wordt op regelmatige tijdsintervallen geactiveerd om algengroei tegen te gaan. Algengroei ontstaat door stilstaand voedingstofrijk water, andere invloeden zijn de hoeveelheid water en de aanwezigheid van schaduw of licht. Het mixreservoir wordt op pijl gehouden wanneer dit te laag komt te staan. <!--Beetje een rare zin--> Hiervoor wordt gebruik gemaakt van een ultrasone sensor om de hoogte van het reservoir te bepalen. Deze sensoren werden simpelweg gekalibreerd door een meting te doen wanneer het reservoir leeg en vol is.
...
<!--Herhaling, zelfde verwijzing naar lades--> 


### UV-C
<!-- Ik krijg het gevoel dat er redelijk wat herhaling is op deze pagina-->
<!-- Kan hier niet veel meer vermelden dat al op andere plaatsen word vermeld-->
De UV-C lamp word geplaatst in het mengreservoir, dit is het reservoir met de voedingsstoffen en de meeste verontreiniging.
...
...
De resevoirs zijn bedoeld als opslag van zuiver water, voedingsstoffen, en restwater. <!-- Restwater?-->
...
- **Voordelen:** <!-- Makkelijke modulariteit-->    
    - Snelle installatie
    - Hergebruikbaar
    - Sterke afdichting 
    - Compact
...
<!-- Ik denk dat alles van oud (inhoudelijk) ondertussen is opgenomen in nieuw -->